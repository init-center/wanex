...
export interface PluginManagementUnavailable {
  readonly kind: "product.plugin-management.unavailable"
...
export interface ProductPluginManagementInvalidatedEvent {
  readonly kind: "product.plugin-management.invalidated"
  readonly sequence: number
  readonly at: number
  readonly revision: string
}

export type ProductPluginManagementEventListener = (
  event: ProductPluginManagementInvalidatedEvent,
) => void

export interface ProductPluginManagementEvents {
  subscribePluginManagementEvents(
    listener: ProductPluginManagementEventListener,
  ): () => void
}

export interface ProductPluginManagementCommands {
