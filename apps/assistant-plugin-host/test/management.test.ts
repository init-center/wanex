...
import type { PluginManagementPort } from "@wanex/assistant/plugin-management"
import {
  createAssistantPluginHost,
  type AssistantPluginHost,
} from "../src/index.js"
...
const hosts: AssistantPluginHost[] = []
...
describe("Plugin command management", () => {
  ...
  it("starts empty and bounds native selection outcomes", async () => {
    ...
    expect(fixture.host.assistantBinding.pluginManagement).toBe(management)
...
function requireManagement(host: AssistantPluginHost): PluginManagementPort {
