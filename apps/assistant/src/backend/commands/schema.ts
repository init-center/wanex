...
import type {
  BackendCommandInputValidationIssue
} from "../model/index.js"

const MAX_ISSUES = 32

export function validateBackendCommandSchemaInput(
  schema: AppCommandInputSchema,
  input: unknown
): readonly BackendCommandInputValidationIssue[] {
  if (input === undefined) {
...
interface ValidationState {
  readonly issues: BackendCommandInputValidationIssue[]
