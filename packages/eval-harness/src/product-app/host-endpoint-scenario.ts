...
export const productAppHostEndpointContractScenario = createEvalScenario({
  ...
  title: "Product App exposes a platform-neutral host endpoint",
  tags: [
    "product-app",
    "surface",
    "host-endpoint",
  ...
  async run(context) {
    ...
    try {
      ...
      const failingEndpoint = createProductAppSurfaceHostEndpoint({
        surface,
        observeRequest() {
          throw new Error(
      ...
      assert(
        ...
        "host endpoint client should read surface events"
      )
      assert(
        status.ok &&
      ...
      assert(
        ...
        "host endpoint client should poll events after a sequence cursor"
      )
      assert(
        !malformed.ok &&
      ...
      assert(
        ...
        "host endpoint should not change Product App distribution closure"
      )
