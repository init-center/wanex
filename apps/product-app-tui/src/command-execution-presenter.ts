...
import type { ProductAppTuiRenderedCommandExecution } from "./types.js"

export function renderProductAppTuiCommandExecution(
  result: ProductAppExecuteCommandResult
): ProductAppTuiRenderedCommandExecution {
  const lines = [
  ...
  if (result.kind === "completed") {
    ...
    return {
      kind: "product-app-tui.command-execution",
      state: "completed",
