...
export interface BackendConversationSettlementFixture {
  readonly storage: {
    readonly kind: "injected"
    readonly handle: Pick<StorageHandle, "core" | "transport">
  }
  readonly settlements: BackendConversationSettlementObserver
  dispose(): Promise<void>
}

export interface BackendConversationSettlementObserver {
...
export function createBackendConversationSettlementFixture(options: {
  readonly storeDir: string
  readonly serviceBin: string
}): BackendConversationSettlementFixture {
