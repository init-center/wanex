...
// @public (undocumented)
type ChannelProjectionTarget = SessionTurnProjectionTarget | TeamMessageProjectionTarget | WorkspaceTaskProjectionTarget | IgnoredProjectionTarget;

// @public (undocumented)
type ChannelProjectionTargetKind = "session.turn" | "team.message" | "workspace.task" | "ignored";
...
// @public (undocumented)
interface TeamMessageProjectionTarget {
    // (undocumented)
