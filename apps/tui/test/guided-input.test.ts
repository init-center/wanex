...
import { collectTuiCommandInput } from "../src/input/guided.js"

describe("TUI guided command input", () => {
...
async function collect(
  command: {
    readonly inputSchema: Parameters<typeof collectTuiCommandInput>[0]["command"]["inputSchema"]
