import { BACKEND_INTEGRATION_CONTRACT } from "@wanex/assistant/backend"
import {
  SURFACE_COMMANDS,
  type SurfaceCommand,
...
export const surfaceCommandDescriptors: readonly SurfaceCommandDescriptor[] =
  [
    ...
    {
      command: SURFACE_COMMANDS.readAssistantCommands,
      title: "Read assistant commands",
      input: "none",
      mutatesState: false
    },
    {
    ...
    {
      command: SURFACE_COMMANDS.dispatchAssistantCommand,
      title: "Dispatch assistant command",
      input: "assistant-command-request",
      mutatesState: false
    },
    {
      command: SURFACE_COMMANDS.dispatchAssistantCommandJson,
      title: "Dispatch assistant JSON command",
      input: "json-body",
      mutatesState: false
    },
    {
      command: SURFACE_COMMANDS.previewAssistantCommandInvocation,
      title: "Preview assistant command invocation",
      input: "assistant-command-invocation-preview",
      mutatesState: false
    },
    {
      command: SURFACE_COMMANDS.executeAssistantCommand,
      title: "Execute assistant command",
      input: "assistant-command-execution",
      mutatesState: true
    },
    {
