...
>["value"]
type HomeSession =
  HomeValue["assistant"]["sessions"]["recent"][number]
...
export function projectRecentSessions(request: {
  ...
  return projectSessions(
    request.home.value.assistant.sessions.recent,
...
export function projectArchivedSessions(request: {
  ...
  return projectSessions(request.home.value.assistant.sessions.archived, undefined)
}
