...
describe("local host resource delivery", () => {
...
describe("local host resource Range parser", () => {
...
function imageResource(content: Uint8Array): ResourceRecord {
  return {
    id: "res_product_local_delivery",
    logicalPath: "resources/product-local-delivery.png",
    kind: "image",
    origin: "model_output",
    state: "available",
    mediaType: "image/png",
