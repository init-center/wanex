...
export interface LocalCliJsonStartupSummary {
  readonly kind: "local-host.cli.startup-summary"
  readonly url: string
  ...
  readonly product: LocalCliJsonProductSummary
...
export interface LocalCliJsonModelEndpointSummary {
  readonly id: string
  readonly connection: LocalSnapshot["modelEndpoints"]["endpoints"][number]["connection"]
  readonly protocol: LocalSnapshot["modelEndpoints"]["endpoints"][number]["protocol"]
  readonly model: LocalSnapshot["modelEndpoints"]["endpoints"][number]["model"]
  readonly active: boolean
  readonly credentialConfigured: boolean
}

export interface LocalCliJsonProductSummary {
...
export interface LocalCliJsonWebSummary {
  ...
  readonly operationStatus: LocalSnapshot["web"]["view"]["operationStatus"]
  readonly providerRunGate: LocalSnapshot["web"]["view"]["providerRunGate"]
}
...
function projectLocalCliModelEndpoint(
  endpoint: LocalSnapshot["modelEndpoints"]["endpoints"][number]
