...
function PlanJourney({
  ...
  const proposal = snapshot.plan.proposal.kind === "product.plan-proposal.found"
...
function preferredTab(snapshot: Snapshot): WorkflowTab {
  ...
  if (snapshot.plan.generation !== undefined || snapshot.plan.proposal.kind === "product.plan-proposal.found") return "plan";
...
function planState(snapshot: Snapshot): string {
  ...
  return snapshot.plan.proposal.kind === "product.plan-proposal.found"
