...
// @public (undocumented)
export function createResourceCleanupHandler(session: WanexSessionCore): WorkerHandler;
...
// @public (undocumented)
export function isWorkerAcknowledgedResult(value: unknown): value is WorkerAcknowledgedResult;
...
// @public (undocumented)
export function registerResourceCleanupHandler(worker: WanexWorker, session: WanexSessionCore): void;
...
// @public (undocumented)
export function startWorkerLoop(worker: WorkerLoopTarget, options?: WorkerLoopOptions): WorkerLoop;
...
// @public (undocumented)
export const WANEX_JOB_RUNTIME: "wanex-job-runtime";

// @public (undocumented)
const WANEX_PROTOCOL_VERSION: 1;

// @public (undocumented)
export const WANEX_RUNTIME_JOBS: "wanex-runtime-jobs";
...
// @public (undocumented)
export function workerAcknowledged(job: SchedulerJobRecord, error?: Error): WorkerAcknowledgedResult;
...
// @public (undocumented)
export type WorkerHandler = (context: WorkerHandlerContext) => Promise<WorkerHandlerReturn> | WorkerHandlerReturn;
