...
import type {
  ...
  BackendDiagnosticsDetailReadModel,
  BackendDiagnosticsSourceSummary
} from "../model/index.js"

export interface ReadBackendDiagnosticsDetailHost {
  readDiagnostics(
...
export async function readBackendDiagnosticsDetail(
  host: ReadBackendDiagnosticsDetailHost,
  options: BackendDiagnosticsDetailOptions = {}
...
): readonly BackendDiagnosticsSourceSummary[] {
