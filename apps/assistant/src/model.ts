...
export interface ShellOptions extends BackendAppOptions {
  ...
  readonly assistantCommands?: NonNullable<BackendAppOptions["assistantCommands"]> & {
...
export interface ShellStatus {
  ...
  readonly assistant: BackendStatus;
...
export interface HomeReadModel {
  readonly kind: "assistant.home";
  readonly state: StateSnapshot;
  readonly assistant: BackendOverviewReadModel;
...
export interface SettingsReadModel {
  readonly kind: "assistant.settings";
  readonly state: StateSnapshot;
...
export interface Shell {
  ...
  readonly pluginManagementEvents: AssistantPluginManagementEvents;
  readonly pluginManagement: AssistantPluginManagementCommands;
  readonly scheduleEvents: ScheduleEvents;
  readonly schedules: ScheduleCommands;
  readonly trustedResources: import("@wanex/assistant/backend").BackendResourceCommands;
  ...
  /**
   * Return the Assistant to an unselected chat composer. Session creation stays
  ...
  readAssistantCommands(): CommandCatalogReadModel;
...
export interface SessionTranscriptNoSessionResult {
  readonly kind: "assistant.session-transcript.no-session";
  readonly message: string;
}
...
export interface WorkbenchNoSessionResult {
  readonly kind: "assistant.workbench.no-session";
  readonly message: string;
}

export interface WorkbenchFailedResult {
  readonly kind: "assistant.workbench.failed";
  readonly sessionId?: string;
  readonly error: SafeError;
}
