...
export interface TeamAvailability {
  readonly kind: "product.team-availability"
...
export interface TeamConversationListReadModel {
  readonly kind: "product.team-conversation-list"
...
export interface TeamConversationPageReadModel {
  readonly kind: "product.team-conversation-page"
...
export type ReadTeamConversationResult =
  | {
      readonly kind: "product.team-conversation.found"
      readonly page: TeamConversationPageReadModel
    }
  | {
      readonly kind: "product.team-conversation.missing"
      readonly conversationId: string
    }
  | {
      readonly kind: "product.team-conversation.no-selection"
    }
  | {
      readonly kind: "product.team-conversation.unavailable"
      readonly availability: TeamAvailability
    }

export interface TeamRoundReceipt {
  readonly kind: "product.team-round.submitted"
  readonly conversation: TeamConversationSummary
...
export interface TeamInvalidatedEvent extends TeamPortInvalidation {
  readonly kind: "product.team.invalidated"
