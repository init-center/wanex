...
export async function runSurfaceCommand(
  ...
  switch (request.command as SurfaceCommand) {
    ...
    case "readAssistantCommands":
      expectSurfaceNoInput(request.input, "readAssistantCommands")
      return app.readAssistantCommands()
    ...
    case "dispatchAssistantCommand":
      return await app.dispatchAssistantCommand(
        parseSurfaceAssistantCommandRequest(request.input)
      )
    case "dispatchAssistantCommandJson":
      return await app.dispatchAssistantCommandJson(
        parseSurfaceJsonBody(request.input)
      )
    case "previewAssistantCommandInvocation":
      return await app.previewAssistantCommandInvocation(
        parseSurfaceCommandInvocationPreviewRequest(request.input)
      )
    case "executeAssistantCommand":
      return await app.executeAssistantCommand(
