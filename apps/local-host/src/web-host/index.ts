...
const DEFAULT_REQUEST_PATH = "/wanex/web/request"
const DEFAULT_ATTACHMENT_PATH = "/wanex/web/attachment"
const DEFAULT_RESOURCE_DELIVERY_PREPARE_PATH =
  "/wanex/web/resource-delivery/prepare"
const DEFAULT_RESOURCE_DELIVERY_PATH = "/wanex/web/resource-delivery"
const DEFAULT_PROVIDER_MANAGEMENT_PATH = "/wanex/web/providers"
const DEFAULT_MODEL_CATALOG_REFRESH_PATH = "/wanex/web/model-catalog-refresh"
const DEFAULT_CAPABILITY_SETUP_PATH = "/wanex/web/capability-setup"
const DEFAULT_EVENT_STREAM_PATH = "/wanex/web/events"
