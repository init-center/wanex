import type { StateCoordinator } from "../state/assistant.js"
import { copyState } from "../state/assistant.js"
import type {
  ...
  const commands: TeamConversationCommands = {
    ...
    async readConversation(request = {}) {
      ...
      if (conversationId === undefined) {
        return { kind: "assistant.team-conversation.no-selection" }
      }
      ...
      return page === null
        ? { kind: "assistant.team-conversation.missing", conversationId }
        : { kind: "assistant.team-conversation.found", page }
    },
