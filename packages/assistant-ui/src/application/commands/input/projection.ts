...
type CommandRow = CommandCatalogReadModel["commands"][number]
...
export const MAX_GENERATED_ARRAY_ITEMS = 256
  ...
  switch (schema.type) {
    ...
    case "array":
      return {
        ...
        maxItems: schema.maxItems ?? MAX_GENERATED_ARRAY_ITEMS,
...
function projectObject(
  ...
  return {
    ...
    maxProperties: schema.maxProperties ?? Object.keys(properties).length,
