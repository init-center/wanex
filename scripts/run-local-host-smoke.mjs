...
export async function createLocalSmokeRun(options) {
  ...
  if (usesSmoke && usesSetupProvider) {
    throw new Error("Local Host one-shot runner cannot combine smoke and setup-provider")
  }
...
export async function createSmokeTempRoot() {
  return mkdtemp(join(tmpdir(), "wanex-local-host-smoke-"))
}
