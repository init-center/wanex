...
// @public (undocumented)
interface CreatePlanProposalRequest extends PlanProposalContent {
    // (undocumented)
...
// @public (undocumented)
interface ExecuteApprovedPlanRequest {
    // (undocumented)
...
export interface PlanStore {
    // (undocumented)
    createPlanProposal(request: CreatePlanProposalRequest): Promise<PlanProposalRecord>;
    // (undocumented)
    executeApprovedPlan(request: ExecuteApprovedPlanRequest): Promise<ExecuteApprovedPlanReceipt>;
    // (undocumented)
