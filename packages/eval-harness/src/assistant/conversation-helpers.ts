...
import type { ConversationPresentationPart } from "@wanex/assistant"
...
export function assistantConversationRowText(row: {
...
export function assistantConversationRowResources(row: {
  readonly parts: readonly ConversationPresentationPart[]
}) {
