import type { BackendIntegrationContract } from "@wanex/assistant/backend"
import type {
...
export const SURFACE_COMMANDS = {
  ...
  dispatchAssistantCommand: "dispatchAssistantCommand",
  dispatchAssistantCommandJson: "dispatchAssistantCommandJson",
...
export interface SurfaceDescriptor {
  readonly kind: "assistant.surface-descriptor"
...
export type SurfaceCommandInputKind =
  ...
  | "assistant-command-request"
  | "assistant-command-invocation-preview"
...
export interface SurfaceEvent {
  ...
  readonly pluginManagement?: AssistantPluginManagementInvalidatedEvent
  readonly schedule?: ScheduleInvalidatedEvent
  readonly error?: SurfaceError
}

export type SurfaceEventType =
  | "assistant.surface.command_completed"
  | "assistant.surface.command_rejected"
