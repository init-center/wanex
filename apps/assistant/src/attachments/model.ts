...
export interface AttachmentDescriptor {
  readonly kind: "assistant.attachment"
...
export interface ConversationAttachmentsReadModel {
  readonly kind: "assistant.conversation-attachments"
...
export interface PrepareConversationAttachmentResult {
  readonly kind: "assistant.conversation-attachment.prepared"
...
export interface RemoveConversationAttachmentResult {
  readonly kind: "assistant.conversation-attachment.removed"
