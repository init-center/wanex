...
export interface CapabilityRequestInteraction {
  readonly kind: "product.capability-request";
...
export interface ConversationApprovalResolvedResult {
  readonly kind: "product.conversation-approval.resolved";
  readonly decision: ConversationApprovalDecision;
...
export interface ConversationRecoveryResolvedResult {
  readonly kind: "product.conversation-recovery.resolved";
  readonly decision: ConversationRecoveryDecision;
  readonly action:
...
export interface CancelTrackedConversationOperationResult {
  readonly kind: "product.conversation-operation.cancel";
  readonly status:
    | "cancelled"
    | "cancel_requested"
    | "already_terminal"
...
export interface PendingGuidedFollowUpReadModel {
  readonly kind: "product.conversation-guided-follow-up.pending";
  readonly operationId: string;
  readonly sessionId: string;
...
export interface ConversationOperationUntrackedResult {
  readonly kind: "product.conversation-operation.untracked";
  readonly sessionId?: string;
  readonly message: string;
}

export interface ConversationOperationMissingResult {
  readonly kind: "product.conversation-operation.missing";
  readonly sessionId: string;
  readonly operationId: string;
  readonly message: string;
}
...
export interface ConversationOperationRejectedResult {
  readonly kind: "product.conversation-operation.rejected";
  readonly reason:
    | "provider_not_ready"
    | "operation_active"
...
export interface ConversationOperationReadModel {
  readonly kind: "product.conversation-operation";
  readonly operationId: string;
  readonly sessionId: string;
  readonly state: BackendConversationOperationState;
  readonly createdAt: number;
...
export interface ConversationAssistantTextDeltaEvent {
  readonly kind: "product.conversation.assistant-text-delta";
...
export interface ConversationOperationInvalidatedEvent {
  readonly kind: "product.conversation.operation-invalidated";
  readonly sequence: number;
  readonly at: number;
  readonly operationId: string;
  readonly sessionId: string;
