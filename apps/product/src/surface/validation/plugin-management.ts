...
export function isPluginManagementReadResult(
  ...
  if (value.kind === "product.plugin-management.unavailable") {
...
export function isProductPluginManagementInvalidatedEvent(
  value: unknown
): value is ProductPluginManagementInvalidatedEvent {
  return exactRecord(value, ["kind", "sequence", "at", "revision"]) &&
    value.kind === "product.plugin-management.invalidated" &&
