...
export interface ProductAppTuiConversationSettlementFixture {
  readonly storage: {
...
export interface ProductAppTuiConversationSettlementObserver {
...
export function createProductAppTuiConversationSettlementFixture(options: {
  readonly storeDir: string
  readonly serviceBin: string
}): ProductAppTuiConversationSettlementFixture {
