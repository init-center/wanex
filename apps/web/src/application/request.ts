...
function readAction(input: unknown):
  ...
  if (!ACTION_TYPES.has(type.value)) {
    return fail({
      code: "invalid_request",
      field: "action.type",
...
const ACTION_TYPES: ReadonlySet<string> = new Set([
  ...
  "dismiss-plan-generation",
  "revise-plan-proposal",
  "decide-plan-proposal",
  "execute-plan-proposal",
  "start-goal",
  "pause-goal",
  "resume-goal",
  "cancel-goal",
  "remove-conversation-attachment",
  "refresh-conversation",
  "load-earlier-history",
  "cancel-conversation",
  "regenerate-conversation",
  "resolve-conversation-approval",
  "resolve-conversation-recovery",
  "create-team-conversation",
  "select-team-conversation",
  "close-team-conversation",
  "add-team-participant",
  "update-team-participant",
  "set-team-coordinator",
  "submit-team-round",
  "load-earlier-team-history",
